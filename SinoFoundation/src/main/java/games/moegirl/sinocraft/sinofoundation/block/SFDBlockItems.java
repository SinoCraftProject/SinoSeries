...
public class SFDBlockItems {
    ...
    public static final RegistryObject<BlockItem> DEEPSLATE_SULPHUR_ORE = ITEMS.register("deepslate_sulphur_ore", () -> new BlockItem(SFDBlocks.DEEPSLATE_SULPHUR_ORE.get(), new Item.Properties()));
