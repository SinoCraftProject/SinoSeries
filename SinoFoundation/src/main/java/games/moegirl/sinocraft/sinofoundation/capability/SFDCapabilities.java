...
public class SFDCapabilities {
    ...
    public static final ResourceLocation BIRTHDAY_NAME = new ResourceLocation(SinoFoundation.MODID, "birthday");
    ...
    public static final Capability<Birthday> BIRTHDAY = CapabilityManager.get(new CapabilityToken<>() {
    });
}
