...
public class ZhHkLangProvider extends AbstractLanguageProvider {
    public ZhHkLangProvider(IDataGenContext context) {
        super(context, "zh_hk");
    }
    ...
    public void generateData(LanguageProviderDelegateBase delegate) {
        ...
        delegate.add(SBRConstants.Translation.DESCRIPTION_FOLDED_FAN_WROTE, "一把摺扇，上面寫着一些字");
        ...
        delegate.add(SBRConstants.Translation.HUD_FAN_PREFIX, "對方的摺扇上寫着：");
        ...
        delegate.add(SBRConstants.Translation.GUI_BRUSH_CANVAS_COPIED, "已將畫布複製到剪貼板");
        delegate.add(SBRConstants.Translation.GUI_BRUSH_CANVAS_PASTED, "已從剪貼板讀取畫布");
        ...
        delegate.add(SBRConstants.Translation.ADVANCEMENT_BRUSH_DESC, "在紙上着墨");
