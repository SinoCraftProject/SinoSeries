...
import games.moegirl.sinocraft.sinocore.datagen.copy.model.AbstractBlockModelProvider;
...
public abstract class AbstractAutoBlockStateProvider extends BlockStateProvider {
    ...
    private final IRegistry<Block>[] deferredRegisters;
    ...
    @SafeVarargs
    public AbstractAutoBlockStateProvider(PackOutput output, String modid, ExistingFileHelper exFileHelper, IRegistry<Block>... deferredRegisters) {
