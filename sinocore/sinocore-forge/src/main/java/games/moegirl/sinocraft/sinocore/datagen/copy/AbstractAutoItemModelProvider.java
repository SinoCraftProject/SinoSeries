...
import games.moegirl.sinocraft.sinocore.datagen.copy.model.UnexceptionalItemModelBuilder;
import games.moegirl.sinocraft.sinocore.datagen.copy.model.WeakCheckModelFile;
...
public abstract class AbstractAutoItemModelProvider extends ItemModelProvider {
    ...
    // DR 适配
    private final IRegistry<? extends ItemLike>[] deferredRegisters;
    ...
    public AbstractAutoItemModelProvider(PackOutput output, String modId, ExistingFileHelper exHelper,
                                         IRegistry<? extends ItemLike>... deferredRegisters) {
