...
public class AbstractLootTableProviderImpl {
    ...
    static class BlockLootTableSubProviderImpl extends BlockLootSubProvider implements IBlockLootTableSubProvider {
        ...
        final static LootItemCondition.Builder HAS_SHEARS_OR_SILK_TOUCH = HAS_SHEARS.or(HAS_SILK_TOUCH);
        final static LootItemCondition.Builder HAS_NO_SHEARS_OR_SILK_TOUCH = HAS_SHEARS_OR_SILK_TOUCH.invert();
    ...
    static class EntityLootTableSubProviderImpl extends EntityLootSubProvider implements IEntityLootTableSubProvider {
        ...
        @Override
        public void add(EntityType<?> entity, ResourceLocation lootTableLocation, LootTable.Builder builder) {
