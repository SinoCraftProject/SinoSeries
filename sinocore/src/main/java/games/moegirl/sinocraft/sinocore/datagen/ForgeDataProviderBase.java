...
import games.moegirl.sinocraft.sinocore.datagen.delegate.ProviderDelegateBase;
 ...
 * <ul>
 *     <li>{@link ForgeDataProviderBase}: 负责将 Forge 的 DataProvider 转发到 common 端的 DataGenerator</li>
...
public abstract class ForgeDataProviderBase<T extends ProviderDelegateBase<T>> implements DataProvider {
    ...
    public ForgeDataProviderBase(T delegate) {
