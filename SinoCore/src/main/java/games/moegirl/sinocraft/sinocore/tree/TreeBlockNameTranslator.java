    ...
    static {
        // 简体中文
        {
            ZH_CN_TRANSLATORS = ImmutableMap.<TreeBlockType, StringDecorator>builder()
                    ...
                    .put(TreeBlockType.LOG_WOOD, StringDecorator.noOp())
                    .put(TreeBlockType.STRIPPED_LOG_WOOD, StringDecorator.appendFront("去皮"))
                    .put(TreeBlockType.SAPLING, StringDecorator.appendBack("树苗"))
                    .put(TreeBlockType.POTTED_SAPLING, StringDecorator.appendBack("树苗盆栽"))
                    ...
                    .put(TreeBlockType.WALL_SIGN, StringDecorator.appendBack("告示牌"))
                    .put(TreeBlockType.HANGING_SIGN, StringDecorator.insertMiddle("悬挂式", "告示牌"))
                    .put(TreeBlockType.WALL_HANGING_SIGN, StringDecorator.insertMiddle("悬挂式", "告示牌"))
        ...
        // 繁體中文（香港）
        {
            ZH_HK_TRANSLATORS = ImmutableMap.<TreeBlockType, StringDecorator>builder()
                    ...
                    .put(TreeBlockType.LOG_WOOD, StringDecorator.noOp())
                    .put(TreeBlockType.STRIPPED_LOG_WOOD, StringDecorator.appendFront("剝皮"))
                    .put(TreeBlockType.SAPLING, StringDecorator.appendBack("樹苗"))
                    .put(TreeBlockType.POTTED_SAPLING, StringDecorator.appendBack("樹苗盆栽"))
                    ...
                    .put(TreeBlockType.WALL_SIGN, StringDecorator.appendBack("指示牌"))
                    .put(TreeBlockType.HANGING_SIGN, StringDecorator.appendBack("吊牌"))
                    .put(TreeBlockType.WALL_HANGING_SIGN, StringDecorator.appendBack("吊牌"))
                    .put(TreeBlockType.BOAT, StringDecorator.appendBack("船"))
        ...
        // 正體中文（台灣）
        {
            ZH_TW_TRANSLATORS = ImmutableMap.<TreeBlockType, StringDecorator>builder()
                    .put(TreeBlockType.LOG, StringDecorator.appendBack("原木"))
                    .put(TreeBlockType.STRIPPED_LOG, StringDecorator.insertMiddle("剝皮", "原木"))
                    .put(TreeBlockType.LOG_WOOD, StringDecorator.appendBack("塊"))
                    .put(TreeBlockType.STRIPPED_LOG_WOOD, StringDecorator.insertMiddle("剝皮", "塊"))
                    .put(TreeBlockType.SAPLING, StringDecorator.appendBack("樹苗"))
                    .put(TreeBlockType.POTTED_SAPLING, StringDecorator.appendBack("樹苗盆栽"))
                    ...
                    .put(TreeBlockType.WALL_HANGING_SIGN, StringDecorator.insertMiddle("懸挂式", "告示牌"))
                    .put(TreeBlockType.BOAT, StringDecorator.appendBack("船"))
                    .put(TreeBlockType.CHEST_BOAT, StringDecorator.insertMiddle("儲物箱", "船"))
                    .build();
        }
        ...
        // 文言（華夏）
        {
            LZH_TRANSLATORS = ImmutableMap.<TreeBlockType, StringDecorator>builder()
                    ...
                    .put(TreeBlockType.LOG_WOOD, StringDecorator.appendBack("木"))
                    .put(TreeBlockType.STRIPPED_LOG_WOOD, StringDecorator.insertMiddle("既扡", "木"))
                    .put(TreeBlockType.SAPLING, StringDecorator.appendBack("秧"))
                    .put(TreeBlockType.POTTED_SAPLING, StringDecorator.appendBack("秧盆景"))
                    .put(TreeBlockType.PLANKS, StringDecorator.appendBack("材"))
                    ...
                    .put(TreeBlockType.WALL_SIGN, StringDecorator.appendBack("牌"))
                    .put(TreeBlockType.HANGING_SIGN, StringDecorator.appendBack("懸牌"))
                    .put(TreeBlockType.WALL_HANGING_SIGN, StringDecorator.appendBack("懸牌"))
        ...
        // English
        {
            EN_TRANSLATORS = ImmutableMap.<TreeBlockType, StringDecorator>builder()
                    ...
                    .put(TreeBlockType.LOG_WOOD, StringDecorator.appendBack(" Wood"))
                    .put(TreeBlockType.STRIPPED_LOG_WOOD, StringDecorator.insertMiddle("Stripped ", " Wood"))
                    .put(TreeBlockType.SAPLING, StringDecorator.appendBack("Sapling"))
                    .put(TreeBlockType.POTTED_SAPLING, StringDecorator.insertMiddle("Potted ", " Sapling"))
                    ...
                    .put(TreeBlockType.WALL_SIGN, StringDecorator.appendBack(" Sign"))
                    .put(TreeBlockType.HANGING_SIGN, StringDecorator.appendBack(" Hanging Sign"))
                    .put(TreeBlockType.WALL_HANGING_SIGN, StringDecorator.appendBack(" Hanging Sign"))
