...
public class SDBlocks {
    ...
    public static final Supplier<Block> MARBLE_BALUSTRADE = BLOCKS.register("marble_balustrade", () -> new MarbleBalustradeBlock(BlockBehaviour.Properties.copy(MARBLE_BLOCK.get()).forceSolidOn()));
}
