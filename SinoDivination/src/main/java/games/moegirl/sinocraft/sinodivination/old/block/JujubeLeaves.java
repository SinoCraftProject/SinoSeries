...
public class JujubeLeaves extends LeavesBlock implements ILootableBlock {
    ...
    public LootTable.Builder createLootBuilder(BlockLootables helper) {
        ...
        return helper.createSilkTouchOrShearsDispatchTable(this, ((LootPoolSingletonContainer.Builder<?>) helper.applyExplosionCondition(false, LootItem.lootTableItem(SDTrees.JUJUBE.getItem(TreeBlockType.SAPLING))))
